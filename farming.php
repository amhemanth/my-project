...
<!-- //custom-theme -->
<link href="css/farming/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="css/farming/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script type="text/javascript" src="js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<link href="css/farming/mislider.css" rel="stylesheet" type="text/css" />
<link href="css/farming/mislider-custom.css" rel="stylesheet" type="text/css" />
<!-- font-awesome-icons -->
<link href="css/farming/font-awesome.css" rel="stylesheet">
<!-- //font-awesome-icons -->
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						<img src="images/farming/4.jpg" alt=" " class="img-responsive" />
	...
	<div class="welcome">
		<div class="container">
			...
			<div class="w3_agile_image">
				<img src="images/farming/1.png" alt=" " class="img-responsive" />
			</div>
...
<!---728x90--->
		...
		<div class="mis-stage w3_agileits_welcome_grids">
			...
			<ol class="mis-slider">
				<li class="mis-slide">
					<figure>
						<img src="images/farming/2.png" alt=" " class="img-responsive" />
						<figcaption>Strawberry</figcaption>
					</figure>
				</li>
				<li class="mis-slide">
					<figure>
						<img src="images/farming/3.png" alt=" " class="img-responsive" />
						<figcaption>Orange</figcaption>
					</figure>
				</li>
				<li class="mis-slide">
					<figure>
						<img src="images/farming/4.png" alt=" " class="img-responsive" />
						<figcaption>Pomegranates</figcaption>
					</figure>
				</li>
				<li class="mis-slide">
					<figure>
						<img src="images/farming/5.png" alt=" " class="img-responsive" />
						<figcaption>Lemon</figcaption>
					</figure>
				</li>
				<li class="mis-slide">
					<figure>
						<img src="images/farming/6.png" alt=" " class="img-responsive" />
						<figcaption>Kiwi Fruits</figcaption>
					</figure>
				</li>
				<li class="mis-slide">
					<figure>
						<img src="images/farming/7.png" alt=" " class="img-responsive" />
		...
		<div class="col-md-6 wthree_welcome_bottom_left">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="images/farming/8.png" alt=" " class="img-responsive" />
				</div>
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="images/farming/9.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="images/farming/10.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="col-md-6 wthree_welcome_bottom_left_grid">
				<div class="w3l_social_icon_gridl">
					<img src="images/farming/11.png" alt=" " class="img-responsive" />
				</div>
				<div class="w3l_social_icon_gridr">
			...
			<div class="w3ls_news_grids">
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="images/farming/3.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="images/farming/6.jpg" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>plantation</h3></div>
						</div>
					</div>
				...
				<div class="col-md-4 w3ls_news_grid">
					<div class="w3layouts_news_grid">
						<img src="images/farming/5.jpg" alt=" " class="img-responsive" />
						<div class="w3layouts_news_grid_pos">
							<div class="wthree_text"><h3>plantation</h3></div>
						</div>
					</div>
