...
<section class="about py-5" id="about">
	<div class="container py-lg-5 py-sm-3">
		<h3 class="heading mb-sm-5 mb-4 text-center"> About AgroLife</h3>
		<div class="row">
			<div class="col-lg-6 about-left">
				<h5 class="mb-3">Few Words About Us!</h5>
				<h3 class="mb-lg-4 mb-2">We are innovators in agricultural business</h3>
				<h4 class=""> our goal is to bring healthy food to every people and help Farmers in Farming</h4>
			</div>
...
<div class="abt_bottom py-md-5">
	<div class="container py-md-4 py-5">
		<div class="row">
			...
			<div class="col-md-3">
				<a href="services.php" class="text-capitalize serv_link btn">our Services</a>
			</div>
		</div>
	</div>
</div>
